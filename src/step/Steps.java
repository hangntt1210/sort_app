...
public class Steps {
    ...
    public void addSwapStep(Element node1, Element node2, boolean isHeap) {

        SwapStep s = new SwapStep(node1, node2, true);

        add(s);
    }
    
    public void addCompareStep(Element node1, Element node2, boolean isHeap) {
